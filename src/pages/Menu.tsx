...
const Menu = () => {
  const menuItems: MenuItem[] = [
    ...
    { id: 4, name: "Mocha Deluxe", description: "Rich chocolate blended with espresso and steamed milk", price: "$5.25", category: "Hot Beverages", image: "photo-1578662996442-48f60103fc96", isVegetarian: true },
    { id: 5, name: "Chai Tea Latte", description: "Aromatic spiced tea with steamed milk and honey", price: "$4.50", category: "Hot Beverages", image: "photo-1571934811086-9bf9b191d28e", isVegetarian: true, isSpicy: true },
    { id: 6, name: "Hot Chocolate Supreme", description: "Belgian chocolate with whipped cream and marshmallows", price: "$4.25", category: "Hot Beverages", image: "photo-1542990253-0b8de10fb86d", isVegetarian: true },
    ...
    { id: 8, name: "Green Tea", description: "Organic Japanese sencha with delicate flavor", price: "$3.25", category: "Hot Beverages", image: "photo-1556881286-fc3e98a56fcc", isVegan: true, isGlutenFree: true },
    ...
    { id: 17, name: "Eggs Benedict", description: "Poached eggs on English muffin with hollandaise", price: "$11.95", category: "Breakfast", image: "photo-1565299624946-b28f40a0ca4b", isVegetarian: true },
    ...
    { id: 20, name: "Oatmeal Bowl", description: "Steel-cut oats with fresh fruits and nuts", price: "$7.25", category: "Breakfast", image: "photo-1571115764595-644a1f56a55c", isVegan: true, isGlutenFree: true },
    ...
    { id: 24, name: "BLT Sandwich", description: "Bacon, lettuce, tomato on toasted sourdough", price: "$9.50", category: "Lunch", image: "photo-1553909489-cd47e0ef937f", },
    ...
    { id: 26, name: "Fish Tacos", description: "Grilled fish with cabbage slaw and lime crema", price: "$13.25", category: "Lunch", image: "photo-1565299585323-38174c6ba4e7", },
    ...
    { id: 31, name: "Macarons", description: "Delicate French cookies in assorted flavors", price: "$2.50", category: "Pastries & Desserts", image: "photo-1558312657-b2c6bf04d3ac", isVegetarian: true, isGlutenFree: true },
    ...
    // Snacks & Light Bites
    { id: 33, name: "Hummus Plate", description: "House-made hummus with vegetables and pita", price: "$7.50", category: "Snacks & Light Bites", image: "photo-1571197919753-2f303665a1e3", isVegan: true },
    ...
    { id: 35, name: "Bruschetta", description: "Toasted bread with tomatoes, basil, and balsamic", price: "$6.75", category: "Snacks & Light Bites", image: "photo-1572441709797-70ad9b6bc19d", isVegetarian: true },
    ...
    { id: 37, name: "Mixed Nuts", description: "Premium roasted nuts with sea salt", price: "$4.50", category: "Snacks & Light Bites", image: "photo-1599599810694-57a2ca8276a8", isVegan: true, isGlutenFree: true },

    // Specialty Items
    { id: 38, name: "Affogato", description: "Vanilla gelato drowned in hot espresso", price: "$5.75", category: "Specialty Items", image: "photo-1578662996442-48f60103fc96", isVegetarian: true },
    ...
    { id: 42, name: "Golden Milk Latte", description: "Turmeric latte with coconut milk and spices", price: "$4.95", category: "Specialty Items", image: "photo-1571934811086-9bf9b191d28e", isVegan: true, isSpicy: true },
